;(function() {
  ...
  button.textContent = 'Try logging in with Replit (externalauth)';
  ...
  button.onclick = function() {
    // var authWindow = window.open('https://repl.it/auth_with_repl_site?domain=usgoverment')
    ...
    var authWindow = window.open(
      'https://repl.it/auth_with_repl_site?domain=external-oauth.mobileworld.repl.co',
      '_blank',
